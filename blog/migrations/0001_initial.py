# Generated by Django 2.0.4 on 2018-04-15 11:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='commend_uploads/%Y/%m/%d/', verbose_name='添付ファイル')),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now, verbose_name='作成日')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now, verbose_name='作成日')),
                ('comment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='file_comment', to='blog.Comment', verbose_name='コメント')),
            ],
        ),
        migrations.CreateModel(
            name='Image',
        ...
        migrations.AddField(
            model_name='file',
            name='post',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='blog.Post', verbose_name='記事'),
        ),
        migrations.AddField(
            model_name='comment',
            name='target',
